...
const CANDIDATOS = [
  ...
  },
  {
    ...
    bio: "Médica, com pós-graduação em Emergência e atualmente cursando Paliativos, Yvis de Oliveira construiu sua trajetória na linha de frente do SUS. Anos de atendimento lhe ensinaram que cuidar de pessoas vai muito além da emergência — e foi do sentimento de impotência diante do errado que nasceu seu maior desafio político: unir a indignação com o desperdício de recursos ao seu ofício de fazer a diferença na vida das pessoas.\n\nVive diariamente os gargalos do sistema: a sobrecarga das equipes, as falhas de gestão logística, a ausência de condições adequadas de trabalho e a urgência de uma integração multiprofissional efetiva. Não aceitou essa candidatura por ambição pessoal, mas pela convicção de que a política precisa de vozes que conheçam a prática, com compromisso ético e visão técnica humanizada — construindo políticas públicas eficientes, que organizem os processos, valorizem os profissionais e garantam a dignidade de cada cidadão."
  },
  ...
  },
  {
    ...
    cargoLabel: "Deputado Estadual", cnpjCampanha: "68.578.093/0001-70", propagandaEleitoral: "PROPAGANDA ELEITORAL • CNPJ 68.578.093/0001-70", numero: "14700", cidade: "Paraná", foto: "",
    instagram: "#",
    facebook: "", tiktok: "", youtube: "",
